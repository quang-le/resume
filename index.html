        ...
        <div class="sidebar-wrapper">
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fas fa-envelope"></i><a href="mailto: dev.quang.le@gmail.com">dev.quang.le@gmail.com</a></li>
                    <li class="phone"><i class="fas fa-phone"></i><a href="tel:0477606291">0477/606291</a></li>
                   <!-- <li class="website"><i class="fas fa-globe"></i><a href="https://portfolio.quangson.ninja/" target="_blank">Under construction</a></li>-->
                    <li class="linkedin"><i class="fab fa-linkedin-in"></i><a href="https://www.linkedin.com/in/quang-son-le-2b88988/" target="_blank">quang-son-le-2b88988/</a></li>
                    <li class="github"><i class="fab fa-github"></i><a href="https://github.com/quang-le" target="_blank">github.com/quang-le</a></li>
                    <li class="twitter"><i class="fab fa-twitter"></i><a href="https://twitter.com/juanglee1" target="_blank">@QuangLeDev</a></li>
                </ul>
            ...
            <section class="section projects-section">
              ...
              <!--  <div class="intro">
                ...
                <div class="item">
                    ...
                    <span class="project-tagline">A assistant designed to help learners at BeCode find resources about various techs and administrative information related to their cursus </span>
                </div><!--//item-->
            </section><!--//section-->
                ...
                <div class="skillset">        
                    <div class="item">
                        ...
                        <div class="progress level-bar">
						    <div class="progress-bar theme-progress-bar" role="progressbar" style="width: 55%" aria-valuenow="99" aria-valuemin="0" aria-valuemax="100"></div>
						</div>                               
                    </div><!--//item-->
                    ...
                    <div class="item">
                        <h3 class="level-title">DialogFlow</h3>
                        <div class="progress level-bar">
						    <div class="progress-bar theme-progress-bar" role="progressbar" style="width: 30%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
						</div>                                  
                    </div><!--//item-->
                    
                    <div class="item">
                        <h3 class="level-title">GIMP</h3>
                        <div class="progress level-bar">
